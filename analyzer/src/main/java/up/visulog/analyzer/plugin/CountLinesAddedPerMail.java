...
public class CountLinesAddedPerMail implements AnalyzerPlugin {
    private final Configuration configuration;

    private Result result;

    public CountLinesAddedPerMail(Configuration generalConfiguration) {
    ...
    static Result processLog(List<Commit> gitLog) {
        ...
        for (var commit : gitLog) {
            ...
            result.resultsMap.put(commit.author.getPrimaryMail(), nb + commit.numberOfLinesAdded);
        }
    ...
    static class Result extends AnalyzerShape implements AnalyzerPlugin.Result {
        ...
        public Result() {
            super("Count lines added per mail", ChartTypes.COLUMN);
        }
        ...
        public String getResultAsHtmlDiv() {
            StringBuilder html = new StringBuilder("<div>Lines added per mail: \n<ul>\n");
