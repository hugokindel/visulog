...
public class CountFilesChangedPerMail implements AnalyzerPlugin {
    private final Configuration configuration;

    private Result result;

    public CountFilesChangedPerMail(Configuration generalConfiguration) {
    ...
    static class Result extends AnalyzerShape implements AnalyzerPlugin.Result {
        ...
        public Result() {
            super("Count files changed per mail", ChartTypes.COLUMN);
        }
        ...
        public String getResultAsHtmlDiv() {
            StringBuilder html = new StringBuilder("<div>Files changed per mail: \n<ul>\n");
