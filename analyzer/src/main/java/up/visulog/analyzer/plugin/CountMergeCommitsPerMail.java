 ...
 */
public class CountMergeCommitsPerMail implements AnalyzerPlugin {
     ...
     */
    public CountMergeCommitsPerMail(Configuration generalConfiguration) {
    ...
    static class Result extends AnalyzerShape implements AnalyzerPlugin.Result {
        ...
        protected Result() {
            super("Count merge commits per mail", ChartTypes.BAR);
        }
        ...
        public String getResultAsHtmlDiv() {
            StringBuilder html = new StringBuilder("<div>Merge commits per mail: \n<ul>\n");
