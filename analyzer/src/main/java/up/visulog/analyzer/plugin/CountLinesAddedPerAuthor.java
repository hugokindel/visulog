...
public class CountLinesAddedPerAuthor implements AnalyzerPlugin {
    private final Configuration configuration;

    private Result result;

    public CountLinesAddedPerAuthor(Configuration generalConfiguration) {
    ...
    static class Result extends AnalyzerShape implements AnalyzerPlugin.Result {
        ...
        public Result() {
            super("Count lines added per author", ChartTypes.COLUMN);
        }
        ...
        public String getResultAsHtmlDiv() {
            StringBuilder html = new StringBuilder("<div>Lines added per author: \n<ul>\n");
